...
class ShowJsonObjectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSummit.setOnClickListener {
            val productURL = "http://192.168.43.132/Ecommerc/present_json.php?id=" + edtProductId.text.toString()
            ...
            val jsonOR = JsonObjectRequest(Request.Method.GET, productURL, null,
                ...
                Response.ErrorListener { error -> txtProductName.text = error.message })
            requestQ.add(jsonOR)
        }
    }
}
